...
#list of directories and files names to do not try to move
DONT_TOUCH = [MAIN_FOLDER, "files-manager.py"]

#helper: check if file has a defined category
...
def run_extension_changer():
    try:
        base, to = input("Enter the base extension and the replacement extension separated by space (e.g: 'mp3 mp4'): ").split()
    ...
    while True:
        ...
        if choice == "1":
            ...
            show_instructions(
                ...
                2) Make sure that all files and folders are closed.
                3) In order to use the 'anti-organizer' don't change any name of any folder generated.
                4) If you face any unexpected error, solve it by yourself... 
                """
            )
            ...
            print("--> No Help :0| Go read the code <--")
